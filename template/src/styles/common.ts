...
export const layout = {
  ...
  // mixins
  border: (up: number, right: number, bottom: number, left: number) => {
    return {
      borderUpWidth: px(up),
  ...
  padding: (up: number, right: number, bottom: number, left: number) => {
    return {
      paddingUp: px(up),
  ...
  margin: (up: number, right: number, bottom: number, left: number) => {
    return {
      marginUp: px(up),
